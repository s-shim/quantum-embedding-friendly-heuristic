...
for networkID in range(10):
    ...
    nodes = pd.read_csv('../fb/nodes_zip/nodes_%s_%s.csv'%(networkID,0))
    ...
    for rep in range(numInstances):
        ...
        output_file = 'Recursive_fb_Pandas_Log_QUBO_numRuns%s_networkID%s.xlsx'%(numRuns,networkID)
